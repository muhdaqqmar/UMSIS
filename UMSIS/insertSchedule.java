...
public class insertSchedule extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Add New Course Schedule");
    ...
    /* if(className.equals(""))
     {
         errorMsg.add("Class Name cannot be empty.");
     }*/
    ...
    int duration = timeEnd-timeStart;
     ...
     try
     {
        ...
        while(rs.next())
        {
            if(courseId.equals(rs.getString("COURSECODE")) && className.equals(rs.getString("CLASS")) && day.equals(rs.getString("DAY")) && startTime.equals(rs.getString("STARTTIME")))
            {
                found = true;
            }
        }
        ...
        {
            JOptionPane.showMessageDialog(this,"Schedule existed");
        }
        else{
         int sql = statement.executeUpdate
         ("insert into SCHEDULE (COURSECODE,CLASS,DAY,STARTTIME,ENDTIME) values('"+courseId+"' , '"+className+"','"+day+"','"+startTime+"','"+endTime+"')");
         if(sql==1)
         {
            JOptionPane.showMessageDialog(this, "Schedule is insert successfully");
            jTextField2.setText("");
            jTextField3.setText("");
            jTextField4.setText("");
            jTextField5.setText("");
